...
module.exports = async (tx) => {
	...
	if (itx.isSpam){
		notify(`Exchange Bot ${Store.user.ADM.address} notifies _${tx.senderId}_ is a spammer or talks too much. Income ADAMANT Tx: https://explorer.adamant.im/tx/${tx.id}.`, 'warn');
