	...
	(await paymentsDb.find({
		...
		try {
			...
			if (status === false){
				...
				msgNotify = `Exchange Bot ${Store.user.ADM.address} notifies transaction of _${pay.inAmountMessage}_ _${pay.inCurrency}_ is Failed. Tx hash: _${inTxid}_. Income ADAMANT Tx: https://explorer.adamant.im/tx/${admTxId}.`;
