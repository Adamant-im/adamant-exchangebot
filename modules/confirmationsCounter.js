	...
	(await paymentsDb.find({
		...
		try {
			...
			if (status === false){
				...
				msgNotify = `Store.botName notifies transaction of _${pay.inAmountMessage}_ _${pay.inCurrency}_ is Failed. Tx hash: _${inTxid}_. Income ADAMANT Tx: https://explorer.adamant.im/tx/${admTxId}.`;
